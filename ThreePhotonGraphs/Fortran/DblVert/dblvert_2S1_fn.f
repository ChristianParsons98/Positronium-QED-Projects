...
c
     ...
     -     (-2 - p + q - wpr + wqr)*(p + wpr - wr)*(p + wpr + wr)) - 
     ...
     -     (p + wpr + wr)) - tra(-p,2 + p + s,1 + p + s + wqr,pp,qq,rr,pq,pr,
     -    qr)/(8.*p*s*(2 + p - q + s)*(2 + p + q + s)*(-1 - p - wp)*
     -     (-1 - p + wp)*(1 + p + s - wq)**2*(1 + p + s + wq)**2*wqr*
     -     (1 + p - r + s + wqr)*(1 + p + r + s + wqr)*(s - wpr + wqr)*
     -     (s + wpr + wqr)*(p + s + wqr - wr)*(p + s + wqr + wr)) - 
     -  tra(-p,2 + p + s,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (8.*p*s*(2 + p - q + s)*(2 + p + q + s)*(-1 - p - wp)*(-1 - p + wp)*
     -     (1 + p + s - wq)**2*(1 + p + s + wq)**2*(p + s - wqr - wr)*
     -     (p + s + wqr - wr)*wr*(1 - r + wr)*(1 + r + wr)*(-p - wpr + wr)*
     -     (-p + wpr + wr)) + tra(-p,1 + wq,1 + p + wpr,pp,qq,rr,pq,pr,qr)/
     ...
     -     (-1 - p - wpr + wq + wqr)*(p + wpr - wr)*(p + wpr + wr)) + 
     -  tra(-p,1 + wq,1 + p + wpr,pp,qq,rr,pq,pr,qr)/
     -   (16.*p*(-1 - p - wp)*(-1 - p + wp)*wpr*(1 + p - r + wpr)*
     -     (1 + p + r + wpr)*wq**2*(1 - q + wq)*(1 + q + wq)*
     ...
     -     (p + wpr + wr)) + tra(p,1 + wq,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (16.*p*(-1 + p - wp)*(-1 + p + wp)*wq**2*(1 - q + wq)*(1 + q + wq)*
     ...
     -     (-s - wpr + wqr)*(-2 + q + s + wpr - wr)*(-2 + q + s + wpr + wr))
     ...
     -     (s + wpr + wqr)*(-2 + q + wqr - wr)*(-2 + q + wqr + wr)) - 
     ...
     -   (8.*s*(1 - p - wp)*(1 + p - wp)*wp*(1 - q + s + wp)*(1 + q + s + wp)*
     -     (s + wp - wq)**2*(s + wp + wq)**2*(-1 + s + wp - wqr - wr)*
     ...
     -     (-1 + q + wp + wpr + wqr)*(-2 + q + wqr - wr)*(-2 + q + wqr + wr))
     ...
     -   (8.*s*wpr*(s + wpr - wqr)*(s + wpr + wqr)*(-p - wpr - wr)*
     ...
     -     (-1 + wq - wqr - wr)*(-1 + wq + wqr - wr)*wr*(1 - r + wr)*
     -     (1 + r + wr)) + tra(wpr - wr,1 + wq,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (16.*wpr*wq**2*(1 - q + wq)**2*(1 + q + wq)*(-p + wpr - wr)*
     -     (p + wpr - wr)*(-1 - wp + wpr - wr)*(-1 + wp + wpr - wr)*
     -     (-1 - s + wpr + wq - wr)*(-1 + s + wpr + wq - wr)*
     -     (-1 + wq - wqr - wr)*(-1 + wq + wqr - wr)*wr*(1 - r + wr)*
     -     (1 + r + wr)) + tra(wpr - wr,1 + wq,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (16.*wpr*wq**3*(1 - q + wq)*(1 + q + wq)*(-p + wpr - wr)*
     -     (p + wpr - wr)*(-1 - wp + wpr - wr)*(-1 + wp + wpr - wr)*
     -     (-1 - s + wpr + wq - wr)*(-1 + s + wpr + wq - wr)*
     -     (-1 + wq - wqr - wr)*(-1 + wq + wqr - wr)*wr*(1 - r + wr)*
     -     (1 + r + wr)) - tra(wpr - wr,2 + wqr + wr,1 + wr,pp,qq,rr,pq,pr,
     -    qr)/(8.*wpr*wqr*(-s + wpr + wqr)*(s + wpr + wqr)*(-p + wpr - wr)*
     -     (p + wpr - wr)*(-1 - wp + wpr - wr)*(-1 + wp + wpr - wr)*wr*
     -     (1 - r + wr)*(1 + r + wr)*(2 - q + wqr + wr)*(2 + q + wqr + wr)*
     -     (1 - wq + wqr + wr)**2*(1 + wq + wqr + wr)**2) - 
     -  tra(s - wqr - wr,2 + wqr + wr,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (8.*s*(s - wpr - wqr)*(s + wpr - wqr)*wqr*(-p + s - wqr - wr)*
     ...
     -     (-1 + p - s + wq)*(-1 + p + s + wq)*(-1 + wq - wqr - wr)*
     -     (-1 + wq + wqr - wr)*wr*(1 - r + wr)*(1 + r + wr)*(p - wpr + wr)*
     -     (p + wpr + wr)) - tra010(1 - wp,1 + wq,wp + wpr,pp,qq,rr,pq,pr,qr)/
     -   (16.*(1 - p - wp)*(1 + p - wp)*wp*wpr*(-r + wp + wpr)*(r + wp + wpr)*
     -     wq**2*(1 - q + wq)*(1 + q + wq)*(-s - wp + wq)*(s - wp + wq)*
     -     (-wp - wpr + wq - wqr)*(-wp - wpr + wq + wqr)*(-1 + wp + wpr - wr)*
     -     (-1 + wp + wpr + wr)) - 
     ...
     -     (-wp + wpr - wq - wqr)*(wp + wpr - wq - wqr)*wqr*(-r + wq + wqr)*
     -     (r + wq + wqr)*(-1 + wq + wqr - wr)*(-1 + wq + wqr + wr)) - 
     -  tra010(wpr - wr,1 + wq,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (16.*wpr*wq**2*(1 - q + wq)*(1 + q + wq)*(-p + wpr - wr)*
     -     (p + wpr - wr)*(-1 - wp + wpr - wr)*(-1 + wp + wpr - wr)*
     -     (-1 - s + wpr + wq - wr)*(-1 + s + wpr + wq - wr)*
     -     (-1 + wq - wqr - wr)*(-1 + wq + wqr - wr)*wr*(1 - r + wr)*
     -     (1 + r + wr)) - (tra001(1 - s - wq,1 + wq,s + wpr + wq,pp,qq,rr,pq,
     -      pr,qr) - tra100(1 - s - wq,1 + wq,s + wpr + wq,pp,qq,rr,pq,pr,qr))
     -    /(16.*s*wpr*(1 - p - s - wq)*(1 + p - s - wq)*(-s - wp - wq)*
     -     (-s + wp - wq)*wq**2*(1 - q + wq)*(1 + q + wq)*(-r + s + wpr + wq)*
     -     (r + s + wpr + wq)*(-s - wpr - wqr)*(-s - wpr + wqr)*
     -     (-1 + s + wpr + wq - wr)*(-1 + s + wpr + wq + wr)) + 
     ...
     -     wpr*(1 + p - r + wpr)*(1 + p + r + wpr)*(1 + p + s - wq)**2*
     -     (1 + p + s + wq)**2*(s - wpr - wqr)*(s - wpr + wqr)*(p + wpr - wr)*
     -     (p + wpr + wr)) - trb(-p,2 + p + s,1 + p + s + wqr,pp,qq,rr,pq,pr,
     -    qr)/(8.*p*s*(2 + p - q + s)*(2 + p + q + s)*(1 + s - wpq)*
     -     (1 + s + wpq)*(1 + p + s - wq)**2*(1 + p + s + wq)**2*wqr*
     -     (1 + p - r + s + wqr)*(1 + p + r + s + wqr)*(s - wpr + wqr)*
     -     (s + wpr + wqr)*(p + s + wqr - wr)*(p + s + wqr + wr)) - 
     ...
     -     (1 + q + wq)*(-1 + p - s + wq)*(-1 + p + s + wq)*(p - wpq + wq)*
     -     (p + wpq + wq)*(-r + wq - wqr)*(-r + wq + wqr)*(-1 + r - wr)*
     -     (-1 + r + wr)) + trb(p,1 + wq,wq + wqr,pp,qq,rr,pq,pr,qr)/
     ...
     -   (8.*p*wqr*wr*(1 - r + wr)*(1 + r + wr)*(p - wpr + wr)*(p + wpr + wr)*
     -     (2 - q + wqr + wr)*(2 + q + wqr + wr)*(p - s + wqr + wr)*
     -     (p + s + wqr + wr)*(1 + p - wpq + wqr + wr)*
     ...
     -     (-1 + wpq + wpr + wqr)*(-2 + q + wqr - wr)*(-2 + q + wqr + wr)) - 
     ...
     -     (p + wpq - wq)*wq**2*(1 - q + wq)*(1 + q + wq)*
     -     (-1 + wq - wqr - wr)*(-1 + wq + wqr - wr)**2*wr*(1 - r + wr)*
     -     (1 + r + wr)*(wpq - wpr - wq + wr)*(wpq + wpr - wq + wr)) + 
     -  trb(wpq - wq,1 + wq,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (16.*wpq*(-1 - s + wpq)*(-1 + s + wpq)*(-p + wpq - wq)*
     -     (p + wpq - wq)*wq**2*(1 - q + wq)*(1 + q + wq)*
     -     (-1 + wq - wqr - wr)**2*(-1 + wq + wqr - wr)*wr*(1 - r + wr)*
     ...
     -     (-1 + q + r + wqr)*(-2 + q + wqr - wr)*(-2 + q + wqr + wr)) + 
     ...
     -     (-2 + q - wqr - wr)*(-2 + q + wqr - wr)*wr*(1 - r + wr)*
     -     (1 + r + wr)) + trb(wpr - wr,1 + wq,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (16.*wpr*wq**2*(1 - q + wq)*(1 + q + wq)*(-p + wpr - wr)*
     ...
     -   (8.*wpr*wqr*(-s + wpr + wqr)*(s + wpr + wqr)*(1 - wpq + wpr + wqr)*
     -     (1 + wpq + wpr + wqr)*(-p + wpr - wr)*(p + wpr - wr)*wr*
     -     (1 - r + wr)*(1 + r + wr)*(2 - q + wqr + wr)*(2 + q + wqr + wr)*
     -     (1 - wq + wqr + wr)**2*(1 + wq + wqr + wr)**2) - 
     ...
     -     (1 + q + wq)*(-1 + p - s + wq)*(-1 + p + s + wq)*(p - wpq + wq)*
     -     (p + wpq + wq)*(-r + wq - wqr)*(-r + wq + wqr)*(-1 + r - wr)*
     -     (-1 + r + wr)) - trb010(p,1 + wq,wq + wqr,pp,qq,rr,pq,pr,qr)/
     -   (16.*p*wq**2*(1 - q + wq)*(1 + q + wq)*(-1 + p - s + wq)*
     -     (-1 + p + s + wq)*(p - wpq + wq)*(p + wpq + wq)*wqr*
     -     (-r + wq + wqr)*(r + wq + wqr)*(-1 + p - wpr + wq + wqr)*
     -     (-1 + p + wpr + wq + wqr)*(-1 + wq + wqr - wr)*(-1 + wq + wqr + wr)
     ...
     -     (-r + wq + wqr)*(r + wq + wqr)*(-1 + wq + wqr - wr)*
     -     (-1 + wq + wqr + wr)) - 
     -  trb010(wpr - wr,1 + wq,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (16.*wpr*wq**2*(1 - q + wq)*(1 + q + wq)*(-p + wpr - wr)*
     -     (p + wpr - wr)*(-1 - s + wpr + wq - wr)*(-1 + s + wpr + wq - wr)*
     -     (-wpq + wpr + wq - wr)*(wpq + wpr + wq - wr)*(-1 + wq - wqr - wr)*
     -     (-1 + wq + wqr - wr)*wr*(1 - r + wr)*(1 + r + wr)) - 
     -  (trb001(1 - s - wq,1 + wq,s + wpr + wq,pp,qq,rr,pq,pr,qr) - 
     -     trb100(1 - s - wq,1 + wq,s + wpr + wq,pp,qq,rr,pq,pr,qr))/
     -   (16.*s*(1 - s - wpq)*(1 - s + wpq)*wpr*(1 - p - s - wq)*
     -     (1 + p - s - wq)*wq**2*(1 - q + wq)*(1 + q + wq)*
     -     (-r + s + wpr + wq)*(r + s + wpr + wq)*(-s - wpr - wqr)*
     -     (-s - wpr + wqr)*(-1 + s + wpr + wq - wr)*(-1 + s + wpr + wq + wr))
     ...
     -     (p + wpr + wr)) - trc(-p,2 + p + s,r,pp,qq,rr,pq,pr,qr)/
     -   (8.*p*r*s*(2 + p - q + s)*(2 + p + q + s)*(-1 - p - wp)*
     ...
     -     (1 + p + r + wpr)*(1 + p + s - wq)*(1 + p + s + wq)*
     -     (s - wpr - wqr)*(s - wpr + wqr)*(p + wpr - wr)*(p + wpr + wr)) - 
     ...
     -     (p + wpr + wr)) - trc(-p,1 + p + wpq,p + wpq + wqr,pp,qq,rr,pq,pr,
     -    qr)/(8.*p*(-1 - p - wp)*(-1 - p + wp)*wpq*(1 + p - q + wpq)*
     ...
     -     (p + wpr + wr)) - trc(-p,2 + p + wpr + wqr,1 + p + wpr,pp,qq,rr,pq,
     -    pr,qr)/
     -   (8.*p*(-1 - p - wp)*(-1 - p + wp)*wpr*(1 + p - r + wpr)*
     -     (1 + p + r + wpr)*wqr*(2 + p - q + wpr + wqr)*
     -     (2 + p + q + wpr + wqr)*(-s + wpr + wqr)*(s + wpr + wqr)*
     -     (1 - wpq + wpr + wqr)*(1 + wpq + wpr + wqr)*
     -     (1 + p + wpr - wq + wqr)*(1 + p + wpr + wq + wqr)*(p + wpr - wr)*
     -     (p + wpr + wr)) - trc(p,q,r,pp,qq,rr,pq,pr,qr)/
     -   (8.*p*q*r*(-2 + p + q - s)*(-2 + p + q + s)*(-1 + p - wp)*
     ...
     -     (-1 + r + wr)) - trc(p,2 + wqr + wr,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (8.*p*(-1 + p - wp)*(-1 + p + wp)*wqr*wr*(1 - r + wr)*(1 + r + wr)*
     -     (p - wpr + wr)*(p + wpr + wr)*(2 - q + wqr + wr)*
     -     (2 + q + wqr + wr)*(p - s + wqr + wr)*(p + s + wqr + wr)*
     -     (1 + p - wpq + wqr + wr)*(1 + p + wpq + wqr + wr)*
     ...
     -     (-1 + q + wq)*wqr*(-1 + q - r + wqr)*(-1 + q + r + wqr)*
     -     (s - wpr + wqr)*(s + wpr + wqr)*(-2 + q + wqr - wr)*
     -     (-2 + q + wqr + wr)) - 
     ...
     -   (8.*s*(1 - p - wp)*(1 + p - wp)*wp*(1 - q + s + wp)*(1 + q + s + wp)*
     -     (1 + s - wpq)*(1 + s + wpq)*(s + wp - wq)*(s + wp + wq)*
     ...
     -     (1 + r + wpq + wpr + wq)*(-1 - wpq - wpr - wqr)*
     -     (-1 - wpq - wpr + wqr)*(wpq + wpr + wq - wr)*(wpq + wpr + wq + wr))
     ...
     -     (1 + r + wr)*(2 - q + s + wpr + wr)*(2 + q + s + wpr + wr)*
     -     (1 + s + wpr - wq + wr)*(1 + s + wpr + wq + wr)) - 
     -  trc(-wpr - wr,1 + wpq + wpr + wr,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (8.*wpq*(-1 - s + wpq)*(-1 + s + wpq)*wpr*(-1 + wpq + wpr - wqr)*
     -     (-1 + wpq + wpr + wqr)*(-p - wpr - wr)*(p - wpr - wr)*
     -     (-1 - wp - wpr - wr)*(-1 + wp - wpr - wr)*wr*(1 - r + wr)*
     -     (1 + r + wr)*(1 - q + wpq + wpr + wr)*(1 + q + wpq + wpr + wr)*
     -     (wpq + wpr - wq + wr)*(wpq + wpr + wq + wr)) - 
     -  trc(wpr - wr,q,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (8.*q*wpr*(-1 + q - wq)*(-1 + q + wq)*(-p + wpr - wr)*(p + wpr - wr)*
     -     (-2 + q - s + wpr - wr)*(-2 + q + s + wpr - wr)*
     -     (-1 - wp + wpr - wr)*(-1 + wp + wpr - wr)*
     -     (-1 + q - wpq + wpr - wr)*(-1 + q + wpq + wpr - wr)*
     -     (-2 + q - wqr - wr)*(-2 + q + wqr - wr)*wr*(1 - r + wr)*
     -     (1 + r + wr)) - trc(wpr - wr,1 + wq,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (8.*wpr*wq*(1 - q + wq)*(1 + q + wq)*(-p + wpr - wr)*(p + wpr - wr)*
     -     (-1 - wp + wpr - wr)*(-1 + wp + wpr - wr)*(-1 - s + wpr + wq - wr)*
     -     (-1 + s + wpr + wq - wr)*(-wpq + wpr + wq - wr)*
     -     (wpq + wpr + wq - wr)*(-1 + wq - wqr - wr)*(-1 + wq + wqr - wr)*wr*
     -     (1 - r + wr)*(1 + r + wr)) - 
     -  trc(wpr - wr,2 + wqr + wr,1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (8.*wpr*wqr*(-s + wpr + wqr)*(s + wpr + wqr)*(1 - wpq + wpr + wqr)*
     -     (1 + wpq + wpr + wqr)*(-p + wpr - wr)*(p + wpr - wr)*
     -     (-1 - wp + wpr - wr)*(-1 + wp + wpr - wr)*wr*(1 - r + wr)*
     -     (1 + r + wr)*(2 - q + wqr + wr)*(2 + q + wqr + wr)*
