...
c
      ...
      implicit double precision (a-z)
      ans2=-4.0*pq**2*q0*r0+4.0*pq**2*qr+2.0*pq**2*r0**2+4.0*pq**2*r0-
     . 2.0*pq**2*rr+8.0*pq*q0**2*r0-8.0*pq*q0*qr-4.0*pq*q0*r0**2+8.0*pq
     . *q0*r0+4.0*pq*q0*rr-16.0*pq*qr-8.0*pq*r0**2-16.0*pq*r0+8.0*pq*rr
     . -24.0*q0**3*r0+24.0*q0**2*qr+12.0*q0**2*r0**2+72.0*q0**2*r0-12.0
     . *q0**2*rr+32.0*q0*qq*r0-48.0*q0*qr-24.0*q0*r0**2-96.0*q0*r0+24.0
     . *q0*rr-32.0*qq*qr-16.0*qq*r0**2-32.0*qq*r0+16.0*qq*rr+48.0*qr+
     . 24.0*r0**2+48.0*r0-24.0*rr
      ans1=-30.0*p0**2*q0**3*r0+30.0*p0**2*q0**2*qr+15.0*p0**2*q0**2*r0
     . **2+54.0*p0**2*q0**2*r0-15.0*p0**2*q0**2*rr+22.0*p0**2*q0*qq*r0-
     . 24.0*p0**2*q0*qr-12.0*p0**2*q0*r0**2-48.0*p0**2*q0*r0+12.0*p0**2
     . *q0*rr-22.0*p0**2*qq*qr-11.0*p0**2*qq*r0**2-22.0*p0**2*qq*r0+
     . 11.0*p0**2*qq*rr+24.0*p0**2*qr+12.0*p0**2*r0**2+24.0*p0**2*r0-
     . 12.0*p0**2*rr+16.0*p0*pq*q0**2*r0-16.0*p0*pq*q0*qr-8.0*p0*pq*q0*
     . r0**2-8.0*p0*pq*q0*r0+8.0*p0*pq*q0*rr-8.0*p0*pq*qr-4.0*p0*pq*r0
     . **2-8.0*p0*pq*r0+4.0*p0*pq*rr+24.0*p0*q0**3*r0-24.0*p0*q0**2*qr-
     . 12.0*p0*q0**2*r0**2-72.0*p0*q0**2*r0+12.0*p0*q0**2*rr-32.0*p0*q0
     . *qq*r0+48.0*p0*q0*qr+24.0*p0*q0*r0**2+96.0*p0*q0*r0-24.0*p0*q0*
     . rr+32.0*p0*qq*qr+16.0*p0*qq*r0**2+32.0*p0*qq*r0-16.0*p0*qq*rr-
     . 48.0*p0*qr-24.0*p0*r0**2-48.0*p0*r0+24.0*p0*rr+22.0*pp*q0**3*r0-
     . 22.0*pp*q0**2*qr-11.0*pp*q0**2*r0**2-54.0*pp*q0**2*r0+11.0*pp*q0
     . **2*rr-26.0*pp*q0*qq*r0+32.0*pp*q0*qr+16.0*pp*q0*r0**2+64.0*pp*
     . q0*r0-16.0*pp*q0*rr+26.0*pp*qq*qr+13.0*pp*qq*r0**2+26.0*pp*qq*r0
     . -13.0*pp*qq*rr-32.0*pp*qr-16.0*pp*r0**2-32.0*pp*r0+16.0*pp*rr+
     . ans2
      ztra=8.0*ans1
      return
      end
c
      ...
      implicit double precision (a-z)
      ztra100=16.0*(-30.0*p0*q0**3*r0+30.0*p0*q0**2*qr+15.0*p0*q0**2*r0
     . **2+54.0*p0*q0**2*r0-15.0*p0*q0**2*rr+22.0*p0*q0*qq*r0-24.0*p0*
     . q0*qr-12.0*p0*q0*r0**2-48.0*p0*q0*r0+12.0*p0*q0*rr-22.0*p0*qq*qr
     . -11.0*p0*qq*r0**2-22.0*p0*qq*r0+11.0*p0*qq*rr+24.0*p0*qr+12.0*p0
     . *r0**2+24.0*p0*r0-12.0*p0*rr+8.0*pq*q0**2*r0-8.0*pq*q0*qr-4.0*pq
     . *q0*r0**2-4.0*pq*q0*r0+4.0*pq*q0*rr-4.0*pq*qr-2.0*pq*r0**2-4.0*
     . pq*r0+2.0*pq*rr+12.0*q0**3*r0-12.0*q0**2*qr-6.0*q0**2*r0**2-36.0
     . *q0**2*r0+6.0*q0**2*rr-16.0*q0*qq*r0+24.0*q0*qr+12.0*q0*r0**2+
     . 48.0*q0*r0-12.0*q0*rr+16.0*qq*qr+8.0*qq*r0**2+16.0*qq*r0-8.0*qq*
     . rr-24.0*qr-12.0*r0**2-24.0*r0+12.0*rr)
      return
      end
c
      double precision function ztra010(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztra010=16.0*(-45.0*p0**2*q0**2*r0+30.0*p0**2*q0*qr+15.0*p0**2*q0
     . *r0**2+54.0*p0**2*q0*r0-15.0*p0**2*q0*rr+11.0*p0**2*qq*r0-12.0*
     . p0**2*qr-6.0*p0**2*r0**2-24.0*p0**2*r0+6.0*p0**2*rr+16.0*p0*pq*
     . q0*r0-8.0*p0*pq*qr-4.0*p0*pq*r0**2-4.0*p0*pq*r0+4.0*p0*pq*rr+
     . 36.0*p0*q0**2*r0-24.0*p0*q0*qr-12.0*p0*q0*r0**2-72.0*p0*q0*r0+
     . 12.0*p0*q0*rr-16.0*p0*qq*r0+24.0*p0*qr+12.0*p0*r0**2+48.0*p0*r0-
     . 12.0*p0*rr+33.0*pp*q0**2*r0-22.0*pp*q0*qr-11.0*pp*q0*r0**2-54.0*
     . pp*q0*r0+11.0*pp*q0*rr-13.0*pp*qq*r0+16.0*pp*qr+8.0*pp*r0**2+
     . 32.0*pp*r0-8.0*pp*rr-2.0*pq**2*r0+8.0*pq*q0*r0-4.0*pq*qr-2.0*pq*
     . r0**2+4.0*pq*r0+2.0*pq*rr-36.0*q0**2*r0+24.0*q0*qr+12.0*q0*r0**2
     . +72.0*q0*r0-12.0*q0*rr+16.0*qq*r0-24.0*qr-12.0*r0**2-48.0*r0+
     . 12.0*rr)
      return
      end
c
      ...
      implicit double precision (a-z)
      ztra110=32.0*(-45.0*p0*q0**2*r0+30.0*p0*q0*qr+15.0*p0*q0*r0**2+
     . 54.0*p0*q0*r0-15.0*p0*q0*rr+11.0*p0*qq*r0-12.0*p0*qr-6.0*p0*r0**
     . 2-24.0*p0*r0+6.0*p0*rr+8.0*pq*q0*r0-4.0*pq*qr-2.0*pq*r0**2-2.0*
     . pq*r0+2.0*pq*rr+18.0*q0**2*r0-12.0*q0*qr-6.0*q0*r0**2-36.0*q0*r0
     . +6.0*q0*rr-8.0*qq*r0+12.0*qr+6.0*r0**2+24.0*r0-6.0*rr)
      return
      end
c
      double precision function ztra101(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztra101=32.0*(-15.0*p0*q0**3+15.0*p0*q0**2*r0+27.0*p0*q0**2+11.0*
     . p0*q0*qq-12.0*p0*q0*r0-24.0*p0*q0-11.0*p0*qq*r0-11.0*p0*qq+12.0*
     . p0*r0+12.0*p0+4.0*pq*q0**2-4.0*pq*q0*r0-2.0*pq*q0-2.0*pq*r0-2.0*
     . pq+6.0*q0**3-6.0*q0**2*r0-18.0*q0**2-8.0*q0*qq+12.0*q0*r0+24.0*
     . q0+8.0*qq*r0+8.0*qq-12.0*r0-12.0)
      return
      end
c
      double precision function ztra001(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztra001=16.0*(-15.0*p0**2*q0**3+15.0*p0**2*q0**2*r0+27.0*p0**2*q0
     . **2+11.0*p0**2*q0*qq-12.0*p0**2*q0*r0-24.0*p0**2*q0-11.0*p0**2*
     . qq*r0-11.0*p0**2*qq+12.0*p0**2*r0+12.0*p0**2+8.0*p0*pq*q0**2-8.0
     . *p0*pq*q0*r0-4.0*p0*pq*q0-4.0*p0*pq*r0-4.0*p0*pq+12.0*p0*q0**3-
     . 12.0*p0*q0**2*r0-36.0*p0*q0**2-16.0*p0*q0*qq+24.0*p0*q0*r0+48.0*
     . p0*q0+16.0*p0*qq*r0+16.0*p0*qq-24.0*p0*r0-24.0*p0+11.0*pp*q0**3-
     . 11.0*pp*q0**2*r0-27.0*pp*q0**2-13.0*pp*q0*qq+16.0*pp*q0*r0+32.0*
     . pp*q0+13.0*pp*qq*r0+13.0*pp*qq-16.0*pp*r0-16.0*pp-2.0*pq**2*q0+
     . 2.0*pq**2*r0+2.0*pq**2+4.0*pq*q0**2-4.0*pq*q0*r0+4.0*pq*q0-8.0*
     . pq*r0-8.0*pq-12.0*q0**3+12.0*q0**2*r0+36.0*q0**2+16.0*q0*qq-24.0
     . *q0*r0-48.0*q0-16.0*qq*r0-16.0*qq+24.0*r0+24.0)
      return
      end
c
      double precision function ztra011(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztra011=16.0*(-45.0*p0**2*q0**2+30.0*p0**2*q0*r0+54.0*p0**2*q0+
     . 11.0*p0**2*qq-12.0*p0**2*r0-24.0*p0**2+16.0*p0*pq*q0-8.0*p0*pq*
     . r0-4.0*p0*pq+36.0*p0*q0**2-24.0*p0*q0*r0-72.0*p0*q0-16.0*p0*qq+
     . 24.0*p0*r0+48.0*p0+33.0*pp*q0**2-22.0*pp*q0*r0-54.0*pp*q0-13.0*
     . pp*qq+16.0*pp*r0+32.0*pp-2.0*pq**2+8.0*pq*q0-4.0*pq*r0+4.0*pq-
     . 36.0*q0**2+24.0*q0*r0+72.0*q0+16.0*qq-24.0*r0-48.0)
      return
      end
c
      double precision function ztra111(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztra111=32.0*(-45.0*p0*q0**2+30.0*p0*q0*r0+54.0*p0*q0+11.0*p0*qq-
     . 12.0*p0*r0-24.0*p0+8.0*pq*q0-4.0*pq*r0-2.0*pq+18.0*q0**2-12.0*q0
     . *r0-36.0*q0-8.0*qq+12.0*r0+24.0)
      return
      end
c
c
      ...
      implicit double precision (a-z)
      ans2=7.0*pp*qq*rr+32.0*pp*qr+16.0*pp*r0**2+32.0*pp*r0-16.0*pp*rr-
     . 6.0*pq*q0**3*r0+6.0*pq*q0**2*qr+3.0*pq*q0**2*r0**2+34.0*pq*q0**2
     . *r0-3.0*pq*q0**2*rr+14.0*pq*q0*qq*r0-28.0*pq*q0*qr-14.0*pq*q0*r0
     . **2-52.0*pq*q0*r0+14.0*pq*q0*rr-14.0*pq*qq*qr-7.0*pq*qq*r0**2-
     . 14.0*pq*qq*r0+7.0*pq*qq*rr+24.0*pq*qr+12.0*pq*r0**2+24.0*pq*r0-
     . 12.0*pq*rr-12.0*q0**4*r0+12.0*q0**3*qr+6.0*q0**3*r0**2+48.0*q0**
     . 3*r0-6.0*q0**3*rr+20.0*q0**2*qq*r0-36.0*q0**2*qr-18.0*q0**2*r0**
     . 2-108.0*q0**2*r0+18.0*q0**2*rr-20.0*q0*qq*qr-10.0*q0*qq*r0**2-
     . 40.0*q0*qq*r0+10.0*q0*qq*rr+72.0*q0*qr+36.0*q0*r0**2+120.0*q0*r0
     . -36.0*q0*rr+20.0*qq*qr+10.0*qq*r0**2+20.0*qq*r0-10.0*qq*rr-48.0*
     . qr-24.0*r0**2-48.0*r0+24.0*rr
      ans1=6.0*p0**2*q0**3*r0-6.0*p0**2*q0**2*qr-3.0*p0**2*q0**2*r0**2-
     . 30.0*p0**2*q0**2*r0+3.0*p0**2*q0**2*rr-14.0*p0**2*q0*qq*r0+24.0*
     . p0**2*q0*qr+12.0*p0**2*q0*r0**2+48.0*p0**2*q0*r0-12.0*p0**2*q0*
     . rr+14.0*p0**2*qq*qr+7.0*p0**2*qq*r0**2+14.0*p0**2*qq*r0-7.0*p0**
     . 2*qq*rr-24.0*p0**2*qr-12.0*p0**2*r0**2-24.0*p0**2*r0+12.0*p0**2*
     . rr-8.0*p0*pq*q0*r0+8.0*p0*pq*qr+4.0*p0*pq*r0**2+8.0*p0*pq*r0-4.0
     . *p0*pq*rr+6.0*p0*q0**4*r0-6.0*p0*q0**3*qr-3.0*p0*q0**3*r0**2-
     . 42.0*p0*q0**3*r0+3.0*p0*q0**3*rr-14.0*p0*q0**2*qq*r0+36.0*p0*q0
     . **2*qr+18.0*p0*q0**2*r0**2+108.0*p0*q0**2*r0-18.0*p0*q0**2*rr+
     . 14.0*p0*q0*qq*qr+7.0*p0*q0*qq*r0**2+38.0*p0*q0*qq*r0-7.0*p0*q0*
     . qq*rr-72.0*p0*q0*qr-36.0*p0*q0*r0**2-120.0*p0*q0*r0+36.0*p0*q0*
     . rr-24.0*p0*qq*qr-12.0*p0*qq*r0**2-24.0*p0*qq*r0+12.0*p0*qq*rr+
     . 48.0*p0*qr+24.0*p0*r0**2+48.0*p0*r0-24.0*p0*rr-6.0*pp*q0**3*r0+
     . 6.0*pp*q0**2*qr+3.0*pp*q0**2*r0**2+38.0*pp*q0**2*r0-3.0*pp*q0**2
     . *rr+14.0*pp*q0*qq*r0-32.0*pp*q0*qr-16.0*pp*q0*r0**2-64.0*pp*q0*
     . r0+16.0*pp*q0*rr-14.0*pp*qq*qr-7.0*pp*qq*r0**2-14.0*pp*qq*r0+
     . ans2
      ztrb=8.0*ans1
      return
      end
c
      ...
      implicit double precision (a-z)
      ztrb100=8.0*(12.0*p0*q0**3*r0-12.0*p0*q0**2*qr-6.0*p0*q0**2*r0**2
     . -60.0*p0*q0**2*r0+6.0*p0*q0**2*rr-28.0*p0*q0*qq*r0+48.0*p0*q0*qr
     . +24.0*p0*q0*r0**2+96.0*p0*q0*r0-24.0*p0*q0*rr+28.0*p0*qq*qr+14.0
     . *p0*qq*r0**2+28.0*p0*qq*r0-14.0*p0*qq*rr-48.0*p0*qr-24.0*p0*r0**
     . 2-48.0*p0*r0+24.0*p0*rr-8.0*pq*q0*r0+8.0*pq*qr+4.0*pq*r0**2+8.0*
     . pq*r0-4.0*pq*rr+6.0*q0**4*r0-6.0*q0**3*qr-3.0*q0**3*r0**2-42.0*
     . q0**3*r0+3.0*q0**3*rr-14.0*q0**2*qq*r0+36.0*q0**2*qr+18.0*q0**2*
     . r0**2+108.0*q0**2*r0-18.0*q0**2*rr+14.0*q0*qq*qr+7.0*q0*qq*r0**2
     . +38.0*q0*qq*r0-7.0*q0*qq*rr-72.0*q0*qr-36.0*q0*r0**2-120.0*q0*r0
     . +36.0*q0*rr-24.0*qq*qr-12.0*qq*r0**2-24.0*qq*r0+12.0*qq*rr+48.0*
     . qr+24.0*r0**2+48.0*r0-24.0*rr)
      return
      end
c
      ...
      implicit double precision (a-z)
      ztrb010=8.0*(18.0*p0**2*q0**2*r0-12.0*p0**2*q0*qr-6.0*p0**2*q0*r0
     . **2-60.0*p0**2*q0*r0+6.0*p0**2*q0*rr-14.0*p0**2*qq*r0+24.0*p0**2
     . *qr+12.0*p0**2*r0**2+48.0*p0**2*r0-12.0*p0**2*rr-8.0*p0*pq*r0+
     . 24.0*p0*q0**3*r0-18.0*p0*q0**2*qr-9.0*p0*q0**2*r0**2-126.0*p0*q0
     . **2*r0+9.0*p0*q0**2*rr-28.0*p0*q0*qq*r0+72.0*p0*q0*qr+36.0*p0*q0
     . *r0**2+216.0*p0*q0*r0-36.0*p0*q0*rr+14.0*p0*qq*qr+7.0*p0*qq*r0**
     . 2+38.0*p0*qq*r0-7.0*p0*qq*rr-72.0*p0*qr-36.0*p0*r0**2-120.0*p0*
     . r0+36.0*p0*rr-18.0*pp*q0**2*r0+12.0*pp*q0*qr+6.0*pp*q0*r0**2+
     . 76.0*pp*q0*r0-6.0*pp*q0*rr+14.0*pp*qq*r0-32.0*pp*qr-16.0*pp*r0**
     . 2-64.0*pp*r0+16.0*pp*rr-18.0*pq*q0**2*r0+12.0*pq*q0*qr+6.0*pq*q0
     . *r0**2+68.0*pq*q0*r0-6.0*pq*q0*rr+14.0*pq*qq*r0-28.0*pq*qr-14.0*
     . pq*r0**2-52.0*pq*r0+14.0*pq*rr-48.0*q0**3*r0+36.0*q0**2*qr+18.0*
     . q0**2*r0**2+144.0*q0**2*r0-18.0*q0**2*rr+40.0*q0*qq*r0-72.0*q0*
     . qr-36.0*q0*r0**2-216.0*q0*r0+36.0*q0*rr-20.0*qq*qr-10.0*qq*r0**2
     . -40.0*qq*r0+10.0*qq*rr+72.0*qr+36.0*r0**2+120.0*r0-36.0*rr)
      return
      end
c
      double precision function ztrb110(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrb110=8.0*(36.0*p0*q0**2*r0-24.0*p0*q0*qr-12.0*p0*q0*r0**2-
     . 120.0*p0*q0*r0+12.0*p0*q0*rr-28.0*p0*qq*r0+48.0*p0*qr+24.0*p0*r0
     . **2+96.0*p0*r0-24.0*p0*rr-8.0*pq*r0+24.0*q0**3*r0-18.0*q0**2*qr-
     . 9.0*q0**2*r0**2-126.0*q0**2*r0+9.0*q0**2*rr-28.0*q0*qq*r0+72.0*
     . q0*qr+36.0*q0*r0**2+216.0*q0*r0-36.0*q0*rr+14.0*qq*qr+7.0*qq*r0
     . **2+38.0*qq*r0-7.0*qq*rr-72.0*qr-36.0*r0**2-120.0*r0+36.0*rr)
      return
      end
c
      double precision function ztrb101(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrb101=16.0*(6.0*p0*q0**3-6.0*p0*q0**2*r0-30.0*p0*q0**2-14.0*p0*
     . q0*qq+24.0*p0*q0*r0+48.0*p0*q0+14.0*p0*qq*r0+14.0*p0*qq-24.0*p0*
     . r0-24.0*p0-4.0*pq*q0+4.0*pq*r0+4.0*pq+3.0*q0**4-3.0*q0**3*r0-
     . 21.0*q0**3-7.0*q0**2*qq+18.0*q0**2*r0+54.0*q0**2+7.0*q0*qq*r0+
     . 19.0*q0*qq-36.0*q0*r0-60.0*q0-12.0*qq*r0-12.0*qq+24.0*r0+24.0)
      return
      end
c
      double precision function ztrb001(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrb001=16.0*(3.0*p0**2*q0**3-3.0*p0**2*q0**2*r0-15.0*p0**2*q0**2
     . -7.0*p0**2*q0*qq+12.0*p0**2*q0*r0+24.0*p0**2*q0+7.0*p0**2*qq*r0+
     . 7.0*p0**2*qq-12.0*p0**2*r0-12.0*p0**2-4.0*p0*pq*q0+4.0*p0*pq*r0+
     . 4.0*p0*pq+3.0*p0*q0**4-3.0*p0*q0**3*r0-21.0*p0*q0**3-7.0*p0*q0**
     . 2*qq+18.0*p0*q0**2*r0+54.0*p0*q0**2+7.0*p0*q0*qq*r0+19.0*p0*q0*
     . qq-36.0*p0*q0*r0-60.0*p0*q0-12.0*p0*qq*r0-12.0*p0*qq+24.0*p0*r0+
     . 24.0*p0-3.0*pp*q0**3+3.0*pp*q0**2*r0+19.0*pp*q0**2+7.0*pp*q0*qq-
     . 16.0*pp*q0*r0-32.0*pp*q0-7.0*pp*qq*r0-7.0*pp*qq+16.0*pp*r0+16.0*
     . pp-3.0*pq*q0**3+3.0*pq*q0**2*r0+17.0*pq*q0**2+7.0*pq*q0*qq-14.0*
     . pq*q0*r0-26.0*pq*q0-7.0*pq*qq*r0-7.0*pq*qq+12.0*pq*r0+12.0*pq-
     . 6.0*q0**4+6.0*q0**3*r0+24.0*q0**3+10.0*q0**2*qq-18.0*q0**2*r0-
     . 54.0*q0**2-10.0*q0*qq*r0-20.0*q0*qq+36.0*q0*r0+60.0*q0+10.0*qq*
     . r0+10.0*qq-24.0*r0-24.0)
      return
      end
c
      double precision function ztrb011(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrb011=16.0*(9.0*p0**2*q0**2-6.0*p0**2*q0*r0-30.0*p0**2*q0-7.0*
     . p0**2*qq+12.0*p0**2*r0+24.0*p0**2-4.0*p0*pq+12.0*p0*q0**3-9.0*p0
     . *q0**2*r0-63.0*p0*q0**2-14.0*p0*q0*qq+36.0*p0*q0*r0+108.0*p0*q0+
     . 7.0*p0*qq*r0+19.0*p0*qq-36.0*p0*r0-60.0*p0-9.0*pp*q0**2+6.0*pp*
     . q0*r0+38.0*pp*q0+7.0*pp*qq-16.0*pp*r0-32.0*pp-9.0*pq*q0**2+6.0*
     . pq*q0*r0+34.0*pq*q0+7.0*pq*qq-14.0*pq*r0-26.0*pq-24.0*q0**3+18.0
     . *q0**2*r0+72.0*q0**2+20.0*q0*qq-36.0*q0*r0-108.0*q0-10.0*qq*r0-
     . 20.0*qq+36.0*r0+60.0)
      return
      end
c
      double precision function ztrb111(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrb111=16.0*(18.0*p0*q0**2-12.0*p0*q0*r0-60.0*p0*q0-14.0*p0*qq+
     . 24.0*p0*r0+48.0*p0-4.0*pq+12.0*q0**3-9.0*q0**2*r0-63.0*q0**2-
     . 14.0*q0*qq+36.0*q0*r0+108.0*q0+7.0*qq*r0+19.0*qq-36.0*r0-60.0)
      return
      end
c
c
      ...
      implicit double precision (a-z)
      ans2=72.0*p0*qr+36.0*p0*r0**2+72.0*p0*r0-36.0*p0*rr+14.0*pp*pq*q0
     . *r0-14.0*pp*pq*qr-7.0*pp*pq*r0**2-14.0*pp*pq*r0+7.0*pp*pq*rr-
     . 14.0*pp*q0**3*r0+14.0*pp*q0**2*qr+7.0*pp*q0**2*r0**2+38.0*pp*q0
     . **2*r0-7.0*pp*q0**2*rr+14.0*pp*q0*qq*r0-24.0*pp*q0*qr-12.0*pp*q0
     . *r0**2-44.0*pp*q0*r0+12.0*pp*q0*rr-14.0*pp*qq*qr-7.0*pp*qq*r0**2
     . -14.0*pp*qq*r0+7.0*pp*qq*rr+20.0*pp*qr+10.0*pp*r0**2+20.0*pp*r0-
     . 10.0*pp*rr-8.0*pq*q0**2*r0+8.0*pq*q0*qr+4.0*pq*q0*r0**2-16.0*pq*
     . q0*r0-4.0*pq*q0*rr+24.0*pq*qr+12.0*pq*r0**2+24.0*pq*r0-12.0*pq*
     . rr+24.0*q0**3*r0-24.0*q0**2*qr-12.0*q0**2*r0**2-72.0*q0**2*r0+
     . 12.0*q0**2*rr-32.0*q0*qq*r0+48.0*q0*qr+24.0*q0*r0**2+96.0*q0*r0-
     . 24.0*q0*rr+32.0*qq*qr+16.0*qq*r0**2+32.0*qq*r0-16.0*qq*rr-48.0*
     . qr-24.0*r0**2-48.0*r0+24.0*rr
      ans1=6.0*p0**3*q0**2*r0-6.0*p0**3*q0*qr-3.0*p0**3*q0*r0**2-18.0*
     . p0**3*q0*r0+3.0*p0**3*q0*rr+12.0*p0**3*qr+6.0*p0**3*r0**2+12.0*
     . p0**3*r0-6.0*p0**3*rr-6.0*p0**2*pq*q0*r0+6.0*p0**2*pq*qr+3.0*p0
     . **2*pq*r0**2+6.0*p0**2*pq*r0-3.0*p0**2*pq*rr+6.0*p0**2*q0**3*r0-
     . 6.0*p0**2*q0**2*qr-3.0*p0**2*q0**2*r0**2-42.0*p0**2*q0**2*r0+3.0
     . *p0**2*q0**2*rr-6.0*p0**2*q0*qq*r0+36.0*p0**2*q0*qr+18.0*p0**2*
     . q0*r0**2+72.0*p0**2*q0*r0-18.0*p0**2*q0*rr+6.0*p0**2*qq*qr+3.0*
     . p0**2*qq*r0**2+6.0*p0**2*qq*r0-3.0*p0**2*qq*rr-36.0*p0**2*qr-
     . 18.0*p0**2*r0**2-36.0*p0**2*r0+18.0*p0**2*rr-14.0*p0*pp*q0**2*r0
     . +14.0*p0*pp*q0*qr+7.0*p0*pp*q0*r0**2+34.0*p0*pp*q0*r0-7.0*p0*pp*
     . q0*rr-20.0*p0*pp*qr-10.0*p0*pp*r0**2-20.0*p0*pp*r0+10.0*p0*pp*rr
     . +28.0*p0*pq*q0*r0-28.0*p0*pq*qr-14.0*p0*pq*r0**2-28.0*p0*pq*r0+
     . 14.0*p0*pq*rr-24.0*p0*q0**3*r0+24.0*p0*q0**2*qr+12.0*p0*q0**2*r0
     . **2+96.0*p0*q0**2*r0-12.0*p0*q0**2*rr+32.0*p0*q0*qq*r0-72.0*p0*
     . q0*qr-36.0*p0*q0*r0**2-144.0*p0*q0*r0+36.0*p0*q0*rr-32.0*p0*qq*
     . qr-16.0*p0*qq*r0**2-32.0*p0*qq*r0+16.0*p0*qq*rr+ans2
      ztrc=8.0*ans1
      return
      end
c
      ...
      implicit double precision (a-z)
      ztrc100=8.0*(18.0*p0**2*q0**2*r0-18.0*p0**2*q0*qr-9.0*p0**2*q0*r0
     . **2-54.0*p0**2*q0*r0+9.0*p0**2*q0*rr+36.0*p0**2*qr+18.0*p0**2*r0
     . **2+36.0*p0**2*r0-18.0*p0**2*rr-12.0*p0*pq*q0*r0+12.0*p0*pq*qr+
     . 6.0*p0*pq*r0**2+12.0*p0*pq*r0-6.0*p0*pq*rr+12.0*p0*q0**3*r0-12.0
     . *p0*q0**2*qr-6.0*p0*q0**2*r0**2-84.0*p0*q0**2*r0+6.0*p0*q0**2*rr
     . -12.0*p0*q0*qq*r0+72.0*p0*q0*qr+36.0*p0*q0*r0**2+144.0*p0*q0*r0-
     . 36.0*p0*q0*rr+12.0*p0*qq*qr+6.0*p0*qq*r0**2+12.0*p0*qq*r0-6.0*p0
     . *qq*rr-72.0*p0*qr-36.0*p0*r0**2-72.0*p0*r0+36.0*p0*rr-14.0*pp*q0
     . **2*r0+14.0*pp*q0*qr+7.0*pp*q0*r0**2+34.0*pp*q0*r0-7.0*pp*q0*rr-
     . 20.0*pp*qr-10.0*pp*r0**2-20.0*pp*r0+10.0*pp*rr+28.0*pq*q0*r0-
     . 28.0*pq*qr-14.0*pq*r0**2-28.0*pq*r0+14.0*pq*rr-24.0*q0**3*r0+
     . 24.0*q0**2*qr+12.0*q0**2*r0**2+96.0*q0**2*r0-12.0*q0**2*rr+32.0*
     . q0*qq*r0-72.0*q0*qr-36.0*q0*r0**2-144.0*q0*r0+36.0*q0*rr-32.0*qq
     . *qr-16.0*qq*r0**2-32.0*qq*r0+16.0*qq*rr+72.0*qr+36.0*r0**2+72.0*
     . r0-36.0*rr)
      return
      end
c
      ...
      implicit double precision (a-z)
      ztrc010=8.0*(12.0*p0**3*q0*r0-6.0*p0**3*qr-3.0*p0**3*r0**2-18.0*
     . p0**3*r0+3.0*p0**3*rr-6.0*p0**2*pq*r0+18.0*p0**2*q0**2*r0-12.0*
     . p0**2*q0*qr-6.0*p0**2*q0*r0**2-84.0*p0**2*q0*r0+6.0*p0**2*q0*rr-
     . 6.0*p0**2*qq*r0+36.0*p0**2*qr+18.0*p0**2*r0**2+72.0*p0**2*r0-
     . 18.0*p0**2*rr-28.0*p0*pp*q0*r0+14.0*p0*pp*qr+7.0*p0*pp*r0**2+
     . 34.0*p0*pp*r0-7.0*p0*pp*rr+28.0*p0*pq*r0-72.0*p0*q0**2*r0+48.0*
     . p0*q0*qr+24.0*p0*q0*r0**2+192.0*p0*q0*r0-24.0*p0*q0*rr+32.0*p0*
     . qq*r0-72.0*p0*qr-36.0*p0*r0**2-144.0*p0*r0+36.0*p0*rr+14.0*pp*pq
     . *r0-42.0*pp*q0**2*r0+28.0*pp*q0*qr+14.0*pp*q0*r0**2+76.0*pp*q0*
     . r0-14.0*pp*q0*rr+14.0*pp*qq*r0-24.0*pp*qr-12.0*pp*r0**2-44.0*pp*
     . r0+12.0*pp*rr-16.0*pq*q0*r0+8.0*pq*qr+4.0*pq*r0**2-16.0*pq*r0-
     . 4.0*pq*rr+72.0*q0**2*r0-48.0*q0*qr-24.0*q0*r0**2-144.0*q0*r0+
     . 24.0*q0*rr-32.0*qq*r0+48.0*qr+24.0*r0**2+96.0*r0-24.0*rr)
      return
      end
c
      double precision function ztrc110(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrc110=8.0*(36.0*p0**2*q0*r0-18.0*p0**2*qr-9.0*p0**2*r0**2-54.0*
     . p0**2*r0+9.0*p0**2*rr-12.0*p0*pq*r0+36.0*p0*q0**2*r0-24.0*p0*q0*
     . qr-12.0*p0*q0*r0**2-168.0*p0*q0*r0+12.0*p0*q0*rr-12.0*p0*qq*r0+
     . 72.0*p0*qr+36.0*p0*r0**2+144.0*p0*r0-36.0*p0*rr-28.0*pp*q0*r0+
     . 14.0*pp*qr+7.0*pp*r0**2+34.0*pp*r0-7.0*pp*rr+28.0*pq*r0-72.0*q0
     . **2*r0+48.0*q0*qr+24.0*q0*r0**2+192.0*q0*r0-24.0*q0*rr+32.0*qq*
     . r0-72.0*qr-36.0*r0**2-144.0*r0+36.0*rr)
      return
      end
c
      double precision function ztrc101(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrc101=16.0*(9.0*p0**2*q0**2-9.0*p0**2*q0*r0-27.0*p0**2*q0+18.0*
     . p0**2*r0+18.0*p0**2-6.0*p0*pq*q0+6.0*p0*pq*r0+6.0*p0*pq+6.0*p0*
     . q0**3-6.0*p0*q0**2*r0-42.0*p0*q0**2-6.0*p0*q0*qq+36.0*p0*q0*r0+
     . 72.0*p0*q0+6.0*p0*qq*r0+6.0*p0*qq-36.0*p0*r0-36.0*p0-7.0*pp*q0**
     . 2+7.0*pp*q0*r0+17.0*pp*q0-10.0*pp*r0-10.0*pp+14.0*pq*q0-14.0*pq*
     . r0-14.0*pq-12.0*q0**3+12.0*q0**2*r0+48.0*q0**2+16.0*q0*qq-36.0*
     . q0*r0-72.0*q0-16.0*qq*r0-16.0*qq+36.0*r0+36.0)
      return
      end
c
      double precision function ztrc001(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrc001=16.0*(3.0*p0**3*q0**2-3.0*p0**3*q0*r0-9.0*p0**3*q0+6.0*p0
     . **3*r0+6.0*p0**3-3.0*p0**2*pq*q0+3.0*p0**2*pq*r0+3.0*p0**2*pq+
     . 3.0*p0**2*q0**3-3.0*p0**2*q0**2*r0-21.0*p0**2*q0**2-3.0*p0**2*q0
     . *qq+18.0*p0**2*q0*r0+36.0*p0**2*q0+3.0*p0**2*qq*r0+3.0*p0**2*qq-
     . 18.0*p0**2*r0-18.0*p0**2-7.0*p0*pp*q0**2+7.0*p0*pp*q0*r0+17.0*p0
     . *pp*q0-10.0*p0*pp*r0-10.0*p0*pp+14.0*p0*pq*q0-14.0*p0*pq*r0-14.0
     . *p0*pq-12.0*p0*q0**3+12.0*p0*q0**2*r0+48.0*p0*q0**2+16.0*p0*q0*
     . qq-36.0*p0*q0*r0-72.0*p0*q0-16.0*p0*qq*r0-16.0*p0*qq+36.0*p0*r0+
     . 36.0*p0+7.0*pp*pq*q0-7.0*pp*pq*r0-7.0*pp*pq-7.0*pp*q0**3+7.0*pp*
     . q0**2*r0+19.0*pp*q0**2+7.0*pp*q0*qq-12.0*pp*q0*r0-22.0*pp*q0-7.0
     . *pp*qq*r0-7.0*pp*qq+10.0*pp*r0+10.0*pp-4.0*pq*q0**2+4.0*pq*q0*r0
     . -8.0*pq*q0+12.0*pq*r0+12.0*pq+12.0*q0**3-12.0*q0**2*r0-36.0*q0**
     . 2-16.0*q0*qq+24.0*q0*r0+48.0*q0+16.0*qq*r0+16.0*qq-24.0*r0-24.0)
      return
      end
c
      double precision function ztrc011(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrc011=16.0*(6.0*p0**3*q0-3.0*p0**3*r0-9.0*p0**3-3.0*p0**2*pq+
     . 9.0*p0**2*q0**2-6.0*p0**2*q0*r0-42.0*p0**2*q0-3.0*p0**2*qq+18.0*
     . p0**2*r0+36.0*p0**2-14.0*p0*pp*q0+7.0*p0*pp*r0+17.0*p0*pp+14.0*
     . p0*pq-36.0*p0*q0**2+24.0*p0*q0*r0+96.0*p0*q0+16.0*p0*qq-36.0*p0*
     . r0-72.0*p0+7.0*pp*pq-21.0*pp*q0**2+14.0*pp*q0*r0+38.0*pp*q0+7.0*
     . pp*qq-12.0*pp*r0-22.0*pp-8.0*pq*q0+4.0*pq*r0-8.0*pq+36.0*q0**2-
     . 24.0*q0*r0-72.0*q0-16.0*qq+24.0*r0+48.0)
      return
      end
c
      double precision function ztrc111(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrc111=16.0*(18.0*p0**2*q0-9.0*p0**2*r0-27.0*p0**2-6.0*p0*pq+
     . 18.0*p0*q0**2-12.0*p0*q0*r0-84.0*p0*q0-6.0*p0*qq+36.0*p0*r0+72.0
     . *p0-14.0*pp*q0+7.0*pp*r0+17.0*pp+14.0*pq-36.0*q0**2+24.0*q0*r0+
     . 96.0*q0+16.0*qq-36.0*r0-72.0)
      return
      end
c
c
