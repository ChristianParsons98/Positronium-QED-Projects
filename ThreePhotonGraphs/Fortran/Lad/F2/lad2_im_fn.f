...
c
     ...
     -   (8.*p*q*(-1 + p + q - wpq)*(-1 + p + q + wpq)*(-1 + q - wq)**2*
     -     (-1 + q + wq)**2*wqr*(-1 + q - r + wqr)*(-1 + q + r + wqr)*
     -     (-2 + p + q - wpr + wqr)*(-2 + p + q + wpr + wqr)*
     -     (-2 + q + wqr - wr)*(q + wqr - wr)*(-2 + q + wqr + wr)*
     -     (q + wqr + wr)) + ztrb(p,q,-1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (16.*p*q*(-1 + p + q - wpq)*(-1 + p + q + wpq)*(-1 + q - wq)**2*
     -     (-1 + q + wq)**2*(q - wqr - wr)*(q + wqr - wr)*wr*(-1 - r + wr)*
     -     (-1 + r + wr)*(-2 + p - wpr + wr)*(-2 + p + wpr + wr)*(-2 + 2*wr))\
     ...
     -     (-s - wpr - wqr)*(-s - wpr + wqr)*(-2 + q + s + wpr - wr)*
     -     (q + s + wpr - wr)*(-2 + q + s + wpr + wr)*(q + s + wpr + wr))
