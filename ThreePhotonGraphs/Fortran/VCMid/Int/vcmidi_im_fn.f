...
c
     ...
     -   (8.*p*q*(-1 + p - wp)**2*(-1 + p + wp)**2*(-1 + q - wq)**2*
     -     (-1 + q + wq)**2*wqr*(-1 + q - r + wqr)*(-1 + q + r + wqr)*
     -     (-2 + p + q - wpr + wqr)*(-2 + p + q + wpr + wqr)*(q + wqr - wr)*
     -     (q + wqr + wr)) - tra(p,q,-1 + wr,pp,qq,rr,pq,pr,qr)/
     -   (8.*p*q*(-1 + p - wp)**2*(-1 + p + wp)**2*(-1 + q - wq)**2*
     ...
     -   (8.*p*q*(-1 + p - wp)**2*(-1 + p + wp)**2*(-1 + p + q - wpq)*
     ...
     -     (-2 + p + wpr + wr)) + 
     -  ((-2 + p + q - s)*trc(2 - q - s,q,-1 + q + s + wpr,pp,qq,rr,pq,pr,
     -      qr))/
