...
c
      ...
      implicit double precision (a-z)
      ztra=8.0*(-15.0*p0**2*q0**2+12.0*p0**2*q0+11.0*p0**2*qq-12.0*p0**
     . 2+8.0*p0*pq*q0+4.0*p0*pq+12.0*p0*q0**2-24.0*p0*q0-16.0*p0*qq+
     . 24.0*p0+11.0*pp*q0**2-16.0*pp*q0-13.0*pp*qq+16.0*pp-2.0*pq**2+
     . 4.0*pq*q0+8.0*pq-12.0*q0**2+24.0*q0+16.0*qq-24.0)
      return
      end
c
      double precision function ztra100(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztra100=16.0*(-15.0*p0*q0**2+12.0*p0*q0+11.0*p0*qq-12.0*p0+4.0*pq
     . *q0+2.0*pq+6.0*q0**2-12.0*q0-8.0*qq+12.0)
      return
      end
c
      double precision function ztra010(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztra010=16.0*(-15.0*p0**2*q0+6.0*p0**2+4.0*p0*pq+12.0*p0*q0-12.0*
     . p0+11.0*pp*q0-8.0*pp+2.0*pq-12.0*q0+12.0)
      return
      end
c
      double precision function ztra110(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztra110=32.0*(-15.0*p0*q0+6.0*p0+2.0*pq+6.0*q0-6.0)
      return
      end
c
...
c
      ...
      implicit double precision (a-z)
      ztrb=8.0*(3.0*p0**2*q0**2-12.0*p0**2*q0-7.0*p0**2*qq+12.0*p0**2-
     . 4.0*p0*pq+3.0*p0*q0**3-18.0*p0*q0**2-7.0*p0*q0*qq+36.0*p0*q0+
     . 12.0*p0*qq-24.0*p0-3.0*pp*q0**2+16.0*pp*q0+7.0*pp*qq-16.0*pp-3.0
     . *pq*q0**2+14.0*pq*q0+7.0*pq*qq-12.0*pq-6.0*q0**3+18.0*q0**2+10.0
     . *q0*qq-36.0*q0-10.0*qq+24.0)
      return
      end
c
      double precision function ztrb100(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrb100=8.0*(6.0*p0*q0**2-24.0*p0*q0-14.0*p0*qq+24.0*p0-4.0*pq+
     . 3.0*q0**3-18.0*q0**2-7.0*q0*qq+36.0*q0+12.0*qq-24.0)
      return
      end
c
      double precision function ztrb010(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrb010=8.0*(6.0*p0**2*q0-12.0*p0**2+9.0*p0*q0**2-36.0*p0*q0-7.0*
     . p0*qq+36.0*p0-6.0*pp*q0+16.0*pp-6.0*pq*q0+14.0*pq-18.0*q0**2+
     . 36.0*q0+10.0*qq-36.0)
      return
      end
c
      double precision function ztrb110(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrb110=8.0*(12.0*p0*q0-24.0*p0+9.0*q0**2-36.0*q0-7.0*qq+36.0)
      return
      end
c
...
c
      ...
      implicit double precision (a-z)
      ztrc=8.0*(3.0*p0**3*q0-6.0*p0**3-3.0*p0**2*pq+3.0*p0**2*q0**2-
     . 18.0*p0**2*q0-3.0*p0**2*qq+18.0*p0**2-7.0*p0*pp*q0+10.0*p0*pp+
     . 14.0*p0*pq-12.0*p0*q0**2+36.0*p0*q0+16.0*p0*qq-36.0*p0+7.0*pp*pq
     . -7.0*pp*q0**2+12.0*pp*q0+7.0*pp*qq-10.0*pp-4.0*pq*q0-12.0*pq+
     . 12.0*q0**2-24.0*q0-16.0*qq+24.0)
      return
      end
c
      double precision function ztrc100(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrc100=8.0*(9.0*p0**2*q0-18.0*p0**2-6.0*p0*pq+6.0*p0*q0**2-36.0*
     . p0*q0-6.0*p0*qq+36.0*p0-7.0*pp*q0+10.0*pp+14.0*pq-12.0*q0**2+
     . 36.0*q0+16.0*qq-36.0)
      return
      end
c
      double precision function ztrc010(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrc010=8.0*(3.0*p0**3+6.0*p0**2*q0-18.0*p0**2-7.0*p0*pp-24.0*p0*
     . q0+36.0*p0-14.0*pp*q0+12.0*pp-4.0*pq+24.0*q0-24.0)
      return
      end
c
      double precision function ztrc110(p0,q0,r0,pp,qq,rr,pq,pr,qr)
      implicit double precision (a-z)
      ztrc110=8.0*(9.0*p0**2+12.0*p0*q0-36.0*p0-7.0*pp-24.0*q0+36.0)
      return
      end
c
